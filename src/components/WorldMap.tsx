...
// 国家中心坐标（经度, 纬度）- 与地图 NUMERIC_TO_ALPHA2 / COUNTRY_NAMES 对应，缺则无封面与数量
const COUNTRY_CENTERS: Record<string, [number, number]> = {
  ...
  CM: [12, 6], CD: [22, -3], IS: [ -19, 65], NP: [84, 28], LK: [81, 7],
  MM: [96, 20], KH: [105, 12], LA: [103, 18], MN: [104, 46], KZ: [67, 48],
  UZ: [64, 41], TM: [59, 39], AZ: [48, 40], GE: [43, 42], AM: [45, 40],
  BY: [28, 53], LT: [24, 55], LV: [25, 57], EE: [26, 59], SK: [20, 49],
  SI: [15, 46], HR: [16, 45], BA: [18, 44], RS: [21, 44], BG: [25, 43],
  MK: [22, 41], AL: [20, 41], CU: [-79, 22], DO: [-70, 19], JM: [-77, 18],
  HT: [-72, 19], PR: [-66, 18],
  /* 以下补全：地图/国家名存在但原无中心坐标 */
  AD: [1.5, 42.5], AG: [-61.8, 17], AO: [17.5, -12.5], BB: [-59.5, 13.2],
  BH: [50.5, 26], BJ: [2.5, 9.5], BN: [114.5, 4.5], BS: [-78, 24], BT: [90.5, 27.5],
  BW: [24, -22], BF: [-2, 12], BI: [30, -3.5], BZ: [-88.8, 17.2],
  CF: [21, 7], TD: [19, 15], CR: [-84, 10], CG: [15, -1], CY: [33, 35],
  DJ: [43, 11.5], EC: [-78, -2], SV: [-88.9, 13.8], GQ: [10, 2], ER: [39, 15],
  FJ: [178, -18], GA: [11.75, -0.5], GM: [-15.5, 13.5], GH: [-2, 8],
  GT: [-90.5, 15.5], GN: [-10, 10], GY: [-59, 5], HN: [-86.5, 15],
  IL: [34.75, 31.5], CI: [-5, 8], JO: [36.5, 31], KW: [47.5, 29.5], KG: [75, 41],
  LS: [28.5, -29.5], LR: [-9.5, 6.5], LU: [6, 49.75], MG: [46.5, -20],
  MW: [34, -13], ML: [-4, 17], MR: [-10.5, 20], MU: [57.5, -20.3], MD: [29, 47],
  ME: [19.5, 43], MZ: [35, -18], NA: [17, -22], NI: [-85, 13], NE: [9, 16],
  OM: [56, 21], PA: [-80, 9], PG: [145, -6], PY: [-58, -23], QA: [51.5, 25.3],
  RW: [30, -2], SN: [-14.5, 14.5], SL: [-11.5, 8.5], SO: [46, 6], SR: [-56, 4],
  SZ: [31.5, -26.5], TJ: [71, 39], TG: [1, 8], TT: [-61.5, 10.5], TZ: [35, -6],
  UG: [33, 1], AE: [54, 24], UY: [-56, -33], YE: [48, 16], ZM: [28, -15],
  ZW: [30, -20], SS: [30, 7], GL: [-42, 72], TW: [121, 24], KP: [127, 40],
};
